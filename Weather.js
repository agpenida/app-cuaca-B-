...
const tempIcon = require('./img/temperatur.png');
const mainIcon = require('./img/cuaca.png');
  ...
  render() {
    ...
    <View style={styles.containerMain}>
      <View style={styles.box2}>
          <Text style={{ textAlign: 'center', paddingTop: 15,fontSize: 20  }}> Nama Kota</Text>
          <TextInput
                style={{ height: 40, color: '#FFC400',width:200}}
               placeholder= " "
